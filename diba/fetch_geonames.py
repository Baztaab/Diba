...
DEFAULT_GEONAMES_CACHE_NAME = Path("cache") / "diba_geonames_cache"
GEONAMES_CACHE_ENV_VAR = "DIBA_GEONAMES_CACHE_NAME"
...
class FetchGeonames:
    ...
    Args:
        ...
        cache_name: Optional path (directory or filename stem) used by requests-cache.
            Defaults to "cache/diba_geonames_cache" and may also be overridden
            via the environment variable ``DIBA_GEONAMES_CACHE_NAME`` or by
    ...
    def get_serialized_data(self) -> dict[str, str]:
        """
        Returns all the data necessary for the Diba calculation.
...
if __name__ == "__main__":
    ...
    from diba.utilities import setup_logging as configure_logging
