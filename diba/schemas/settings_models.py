...
class DibaSettingsCelestialPointModel(SubscriptableBaseModel):
    """
    ...
    element_points: int = Field(
        title="Celestial Point Element Points", description="Element Points given to the celestial point"
    )
    label: str = Field(
        title="Celestial Point Label",
        description="The name of the celestial point in the chart, it can be different from the name",
    )
    is_active: Optional[bool] = Field(
        title="Celestial Point is Active",
        description="Indicates if the celestial point is active in the chart",
        default=None,
    )


# Language Settings
class DibaLanguageCelestialPointModel(SubscriptableBaseModel):
    """
    ...
    True_North_Lunar_Node: str = Field(
        title="True North Lunar Node", description="The name of True North Lunar Node in the chart, in the language"
    )
    Mean_North_Lunar_Node: str = Field(
        title="Mean North Lunar Node", description="The name of Mean North Lunar Node in the chart, in the language"
    )
    ...
    Medium_Coeli: str = Field(
        title="Medium Coeli", description="The name of Medium Coeli in the chart, in the language"
    )
    ...
    True_South_Lunar_Node: str = Field(
        title="True South Lunar Node", description="The name of True South Lunar Node in the chart, in the language"
    )
    Mean_South_Lunar_Node: str = Field(
    ...
    Pars_Spiritus: str = Field(
        title="Part of Spirit", description="The name of Part of Spirit in the chart, in the language"
    )
    Pars_Amoris: str = Field(title="Part of Love", description="The name of Part of Love in the chart, in the language")
    Pars_Fidei: str = Field(
        title="Part of Faith", description="The name of Part of Faith in the chart, in the language"
    )
...
class DibaLanguageModel(SubscriptableBaseModel):
    """
    ...
    couple_aspects: str = Field(
        title="Couple Aspects", description="The couple aspects label in the chart, in the language"
    )
    synastry_aspects: str = Field(
        title="Synastry Aspects", description="The synastry aspects label in the chart, in the language"
    )
    transit_aspects: str = Field(
        title="Transit Aspects", description="The transit aspects label in the chart, in the language"
    )
    planets_and_house: str = Field(
        title="Planets and House", description="The planets and house label in the chart, in the language"
    )
    ...
    celestial_points: DibaLanguageCelestialPointModel = Field(
        title="Celestial Points", description="The celestial points translations in the chart, in the language"
    )
    composite_chart: str = Field(
        title="Composite Chart", description="The composite chart label in the chart, in the language"
    )
    ...
    apparent_geocentric: str = Field(
        title="Apparent Geocentric", description="The apparent geocentric label in the chart, in the language"
    )
    ...
    first_quarter: str = Field(
        title="First Quarter", description="The first quarter label in the chart, in the language"
    )
    waxing_gibbous: str = Field(
        title="Waxing Gibbous", description="The waxing gibbous label in the chart, in the language"
    )
    full_moon: str = Field(title="Full Moon", description="The full moon label in the chart, in the language")
    waning_gibbous: str = Field(
        title="Waning Gibbous", description="The waning gibbous label in the chart, in the language"
    )
    last_quarter: str = Field(title="Last Quarter", description="The last quarter label in the chart, in the language")
    waning_crescent: str = Field(
        title="Waning Crescent", description="The waning crescent label in the chart, in the language"
    )
    ...
    houses_system_A: str = Field(
        title="Houses System A", description="The houses system A label in the chart, in the language"
    )
    houses_system_B: str = Field(
        title="Houses System B", description="The houses system B label in the chart, in the language"
    )
    houses_system_C: str = Field(
        title="Houses System C", description="The houses system C label in the chart, in the language"
    )
    houses_system_D: str = Field(
        title="Houses System D", description="The houses system D label in the chart, in the language"
    )
    houses_system_F: str = Field(
        title="Houses System F", description="The houses system F label in the chart, in the language"
    )
    houses_system_H: str = Field(
        title="Houses System H", description="The houses system H label in the chart, in the language"
    )
    houses_system_I: str = Field(
        title="Houses System I", description="The houses system I label in the chart, in the language"
    )
    houses_system_i: str = Field(
        title="Houses System i", description="The houses system i label in the chart, in the language"
    )
    houses_system_K: str = Field(
        title="Houses System K", description="The houses system K label in the chart, in the language"
    )
    houses_system_L: str = Field(
        title="Houses System L", description="The houses system L label in the chart, in the language"
    )
    houses_system_M: str = Field(
        title="Houses System M", description="The houses system M label in the chart, in the language"
    )
    houses_system_N: str = Field(
        title="Houses System N", description="The houses system N label in the chart, in the language"
    )
    houses_system_O: str = Field(
        title="Houses System O", description="The houses system O label in the chart, in the language"
    )
    houses_system_P: str = Field(
        title="Houses System P", description="The houses system P label in the chart, in the language"
    )
    houses_system_Q: str = Field(
        title="Houses System Q", description="The houses system Q label in the chart, in the language"
    )
    houses_system_R: str = Field(
        title="Houses System R", description="The houses system R label in the chart, in the language"
    )
    houses_system_S: str = Field(
        title="Houses System S", description="The houses system S label in the chart, in the language"
    )
    houses_system_T: str = Field(
        title="Houses System T", description="The houses system T label in the chart, in the language"
    )
    houses_system_U: str = Field(
        title="Houses System U", description="The houses system U label in the chart, in the language"
    )
    houses_system_V: str = Field(
        title="Houses System V", description="The houses system V label in the chart, in the language"
    )
    houses_system_W: str = Field(
        title="Houses System W", description="The houses system W label in the chart, in the language"
    )
    houses_system_X: str = Field(
        title="Houses System X", description="The houses system X label in the chart, in the language"
    )
    houses_system_Y: str = Field(
        title="Houses System Y", description="The houses system Y label in the chart, in the language"
    )
    ...
    return_aspects: str = Field(
        title="Return Aspects", description="The return aspects label in the chart, in the language"
    )
    ...
    house_position_comparison: str = Field(
    ...
    perspective_type: str = Field(
        title="Perspective Type", description="The perspective type label in the chart, in the language"
    )
...
# Settings Model
class DibaSettingsModel(SubscriptableBaseModel):
    """
    This class is used to define the global settings for the Diba.
    """

    language_settings: dict[str, DibaLanguageModel] = Field(
        title="Language Settings", description="The language settings of the chart"
    )
