...
DibaChartTheme: TypeAlias = Literal[
    "light", "dark", "dark-high-contrast", "classic", "strawberry", "black-and-white"
]
"""Literal type for Diba Chart Themes"""


DibaChartLanguage: TypeAlias = Literal["EN", "FR", "PT", "IT", "CN", "ES", "RU", "TR", "DE", "HI"]
"""Literal type for Diba Chart Languages"""
...
# ---------------------------------------------------------------------------
# Deprecated aliases for backward compatibility with Diba v4.x
# ---------------------------------------------------------------------------
