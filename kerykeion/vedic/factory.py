...
from kerykeion.schemas.kr_models import VedicModel, VedicSettingsModel
from kerykeion.time_contract import datetime_to_julian
from kerykeion.vedic.builder import build_vedic_model
...
class VedicFactoryError(ValueError):
    ...
    Examples:
        ...
        ...
        kerykeion.vedic.factory.VedicFactoryError: Invalid timezone
    """
