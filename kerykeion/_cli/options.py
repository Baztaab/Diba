...
from kerykeion._cli.errors import ValidationError
...
def resolve_ephemeris_path(cli_arg: Optional[str], _offline: bool) -> Optional[str]:
    return cli_arg or os.getenv("KERYKEION_EPHE_PATH")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="kerykeion", description="Kerykeion CLI")
